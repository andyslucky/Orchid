    ...
    fun testFromCamelCase(): List<DynamicTest> {
        ...
        return listOf(
            ...
            DynamicTest.dynamicTest("oneTwoThree (mapped)") {
                expectThat(splitter("oneTwoThree") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            }
        )
    }
    ...
    fun testFromSnakeCase(): List<DynamicTest> {
        ...
        return listOf(
            ...
            DynamicTest.dynamicTest("one_two_three (mapped)") {
                expectThat(splitter("one_two_three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            }
        )
    }
    ...
    fun testFromDashCase(): List<DynamicTest> {
        ...
        return listOf(
            ...
            DynamicTest.dynamicTest("one-two-three (mapped)") {
                expectThat(splitter("one-two-three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            }
        )
    }
    ...
    fun testFromFilename(): List<DynamicTest> {
        ...
        return listOf(
            ...
            DynamicTest.dynamicTest("one two_three (mapped)") {
                expectThat(splitter("one two_three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("one twoThree (mapped)") {
                expectThat(splitter("one twoThree") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("one-two three (mapped)") {
                expectThat(splitter("one-two three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            ...
            DynamicTest.dynamicTest("one_two three (mapped)") {
                expectThat(splitter("one_two three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("one_two-three (mapped)") {
                expectThat(splitter("one_two-three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("one_twoThree (mapped)") {
                expectThat(splitter("one_twoThree") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("oneTwo three (mapped)") {
                expectThat(splitter("oneTwo three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("oneTwo-three (mapped)") {
                expectThat(splitter("oneTwo-three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            },
            DynamicTest.dynamicTest("oneTwo_three (mapped)") {
                expectThat(splitter("oneTwo_three") { it.uppercase(Locale.getDefault()) }).isEqualTo("ONE TWO THREE")
            }
        )
    }
